...
import com.example.videoplayer.activity.Archos_Audio_FilesActivity;
import com.example.videoplayer.model.Archos_MediaFiles;

import java.util.ArrayList;
import java.util.Iterator;

public class Archos_AAudioFoldersAdapter extends RecyclerView.Adapter<Archos_AAudioFoldersAdapter.ViewHolder> {
    private static final String TAG = Archos_AAudioFoldersAdapter.class.getSimpleName();
    private ArrayList<String> folderPath;
    private Activity mContext;
    private ArrayList<Archos_MediaFiles> mediaFiles;
    private String mediaType;

    public Archos_AAudioFoldersAdapter(ArrayList<Archos_MediaFiles> mediaFiles, ArrayList<String> folderPath, Activity mContext, String mediaType) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(this.mContext).inflate(R.layout.archos_audio_folder, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Archos_AAudioFoldersAdapter.this.mContext, Archos_Audio_FilesActivity.class);
                intent.putExtra("folderName", nameOfFolder);
                intent.putExtra("mediaType", Archos_AAudioFoldersAdapter.this.mediaType);
                Archos_AAudioFoldersAdapter.this.mContext.startActivity(intent);
            }
        });
    }
