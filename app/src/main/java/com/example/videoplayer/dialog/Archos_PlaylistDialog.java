...
public class Archos_PlaylistDialog extends BottomSheetDialogFragment {
    private static final String TAG = Archos_PlaylistDialog.class.getSimpleName();
    ...
    public Archos_PlaylistDialog(ArrayList<Archos_MediaFiles> arrayList, Archos_MediaFilesAdapter mediaFilesAdapter) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        this.mediaFilesAdapter = new Archos_MediaFilesAdapter(this.arrayList, getActivity(), mediaType, 1);
