...
public class Archos_Audio_FilesActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    static Archos_AudioFilesAdapter mediaFilesAdapter;
    ImageView back;
    String folder_name;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.archos_activity_audio_files);
//        try {
...
//        }
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Archos_Audio_FilesActivity.this.onBackPressed();
            }
        });
        ...
        this.swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                Archos_Audio_FilesActivity.this.showMediaFiles();
                Archos_Audio_FilesActivity.this.swipeRefreshLayout.setRefreshing(false);
            }
        });
    ...
    public void showMediaFiles() {
        ...
        Archos_AudioFilesAdapter archos_AudioFilesAdapter = new Archos_AudioFilesAdapter(this.mediaFilesArrayList, this, this.mediaType, 0);
        mediaFilesAdapter = archos_AudioFilesAdapter;
        this.recyclerView.setAdapter(archos_AudioFilesAdapter);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == 16908332) {
            ...
            alertDialog.setPositiveButton("Ok", new DialogInterface.OnClickListener() { // from class: com.imusicplayer.fullhdvideoplayer.Archos_RecyclerViewClasses.Archos_Audio_FilesActivity.3
                @Override // android.content.DialogInterface.OnClickListener
                public void onClick(DialogInterface dialogInterface, int i) {
                    editor.apply();
                    Archos_Audio_FilesActivity.this.finish();
                    Archos_Audio_FilesActivity archos_Audio_FilesActivity = Archos_Audio_FilesActivity.this;
                    archos_Audio_FilesActivity.startActivity(archos_Audio_FilesActivity.getIntent());
                    dialogInterface.dismiss();
                }
            });
            String[] items = {"Name (A to Z)", "Size (Big to Small)", "Date (New to Old)", "Length (Long to Short)"};
            alertDialog.setSingleChoiceItems(items, -1, new DialogInterface.OnClickListener() { // from class: com.imusicplayer.fullhdvideoplayer.Archos_RecyclerViewClasses.Archos_Audio_FilesActivity.4
                @Override // android.content.DialogInterface.OnClickListener
                public void onClick(DialogInterface dialogInterface, int i) {
                    switch (i) {
                        case 0:
